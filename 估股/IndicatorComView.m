...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UILabel *companyNameLabel=[[UILabel alloc] initWithFrame:CGRectMake(29,1,55,21)];
        ...
        UILabel *marketPriceLabel=[[UILabel alloc] initWithFrame:CGRectMake(102,1,55,21)];
        ...
        UILabel *googuuPriceLabel=[[UILabel alloc] initWithFrame:CGRectMake(147,1,55,21)];
        ...
        UILabel *outLookingLabel=[[UILabel alloc] initWithFrame:CGRectMake(197,1,55,21)];
